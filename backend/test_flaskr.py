...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.quiz={
            'category':1,
            'previous_questions':['What is the disease of 2020?','What is the loss of 2020?']
        }
    ...
    def test_get_question_search_with_results(self):
        res = self.client().post('/questions/search', json={'searchTerm':'2020'})
        data = json.loads(res.data)
    ...
    def test_get_book_search_without_results(self):
        res = self.client().post('/questions/search', json={'searchTerm':'treshvbhg'})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_404_error_get_questions_on_category(self):
    ...
    def test_404_if_post_new_quiz_not_allowed(self):
